...
public class FriendsApi {
    ...
    @PutMapping
    public ResponseEntity<Boolean> updateFriend(@RequestBody Friends friends){
        return ResponseEntity.ok(friendsServiceImpl.update(friends));
    }

    @DeleteMapping
    public ResponseEntity<Boolean> deleteFriend(@RequestParam Long userId, Long otherUserId){
        return ResponseEntity.ok(friendsServiceImpl.delete(userId,otherUserId));
    }
