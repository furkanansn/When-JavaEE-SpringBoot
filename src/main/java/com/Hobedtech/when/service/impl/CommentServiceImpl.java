...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public Comment add(CommentPostDto commentPostDto) {
    ...
    @Override
    public String delete(CommentDeleteDto commentDeleteDto) {
        Comment comment = commentRepository.getOne(commentDeleteDto.getCommentId());
        if(comment.getUsers().getId().equals(commentDeleteDto.getUserId())){
